...
var _ = Describe("Debian", func() {
	DescribeTable("Inspect should be able to parse checksum files",
		...
		Entry("debian:11 x86_64", "11", "bullseye", "x86_64", "testdata/debian-11-genericcloud-amd64.json",
			&api.ArtifactDetails{
				SHASum: "3c08356d6860f987089c14b45953fb1f266d1b1b50dd086744925e2ed4113b804e848a8b1b46614febc48cd" +
		...
		Entry("debian:11 aarch64", "11", "bullseye", "aarch64", "testdata/debian-11-genericcloud-arm64.json",
			&api.ArtifactDetails{
				SHASum: "c1a1645cf37ce628a8734bb25dce09fcd0858865302635ce0ae88b2da23bb615da43d483984709d743cd6b6" +
		...
		Entry("debian:12 x86_64", "12", "bookworm", "x86_64", "testdata/debian-12-genericcloud-amd64.json",
			&api.ArtifactDetails{
				SHASum: "a58d86525d75fd8e139a2302531ce5d2ab75ef0273cfe78f9d53aada4b23efd45f8433b4806fa4570cfe981" +
		...
		Entry("debian:12 aarch64", "12", "bookworm", "aarch64", "testdata/debian-12-genericcloud-arm64.json",
			&api.ArtifactDetails{
				SHASum: "a17a462acbc3412ef195390fb60dffba2134fef1a276d500ca50a06036c488035657409fcd02f2f70d1e7a9" +
		...
		Entry("debian:13 x86_64", "13", "trixie", "x86_64", "testdata/debian-13-genericcloud-amd64-daily.json",
			&api.ArtifactDetails{
				SHASum: "942c7d24962b4b695ae78ea470561e6cc6bbef737a0afff9768ff1993d819589ec139092b9d0800a791e75781e17b3ad5a45c5b177494aa" +
					"078f268ae4f71722b",
				DownloadURL:          "https://cloud.debian.org/images/cloud/trixie/daily/latest/debian-13-genericcloud-amd64-daily.qcow2",
				ImageArchitecture:    "amd64",
				AdditionalUniqueTags: []string{"13-20250314-2051"},
			},
			&docs.UserData{
				Username: "debian",
			},
		...
		Entry("debian:13 aarch64", "13", "trixie", "aarch64", "testdata/debian-13-genericcloud-arm64-daily.json",
			&api.ArtifactDetails{
				SHASum: "8a101f5a8aa6afa8ffc456079db4c1c1e59ff77317c53ea0a597c947168a774866665493ae0fbfb21d367dcb08f23c4f3af9dd1c3d43255" +
					"986477b951269642d",
				DownloadURL:          "https://cloud.debian.org/images/cloud/trixie/daily/latest/debian-13-genericcloud-arm64-daily.qcow2",
				ImageArchitecture:    "arm64",
				AdditionalUniqueTags: []string{"13-20250314-2051"},
			},
			&docs.UserData{
