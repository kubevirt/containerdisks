...
var _ = Describe("Ubuntu", func() {
	DescribeTable("Inspect should be able to parse checksum files",
		...
		Entry("ubuntu:22.04 x86_64", "22.04", "x86_64", "testdata/SHA256SUM",
			&api.ArtifactDetails{
				SHASum:            "de5e632e17b8965f2baf4ea6d2b824788e154d9a65df4fd419ec4019898e15cd",
		...
		Entry("ubuntu:22.04 aarch64", "22.04", "aarch64", "testdata/SHA256SUM",
			&api.ArtifactDetails{
				SHASum:            "66224c7fed99ff5a5539eda406c87bbfefe8af6ff6b47d92df3187832b5b5d4f",
		...
		Entry("ubuntu:22.04 s390x", "22.04", "s390x", "testdata/SHA256SUM",
			&api.ArtifactDetails{
				SHASum:            "192c18a58917622e12a3bb6aaf246fcc6a76d9562eb9f49d34df81fbc59610af",
